...
public class Assignment extends globalDriver{
	public static void main(String[] args) throws IOException {
		...
		driver.findElement(By.id("txtEmail")).sendKeys("sachinbggowda");
		driver.findElement(By.id("btnPayment")).click();
		String alertmsg4=driver.switchTo().alert().getText();
		System.out.println("alert message is "+alertmsg4);
		driver.switchTo().alert().accept();
		driver.findElement(By.id("txtEmail")).clear();
		driver.findElement(By.id("txtEmail")).sendKeys("sachinbggowda@gmail.com");
		...
		driver.findElement(By.id("txtPhone")).sendKeys("7795979018");
